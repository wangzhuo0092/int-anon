...
# You can set it outside this script, e.g.,
# PROJECT_DIR=/path/to/project bash run_direct.sh
...
# Python executable.
# Use "python" by default, or override it with:
# PYTHON_BIN=/path/to/python bash run_direct.sh
...
# Failure log file.
FAIL_LOG="${SAVE_DIR}/failed_runs_direct.log"

# Optional directory for model symlinks.
# This avoids exposing the original model checkpoint path in output filenames.
